...
echo "
<center>
    <h1 style='color: red;'><strong>[ Halmahera1337 ] - <a href='" .$urlPath . "'>" .$_SERVER['HTTP_HOST']. "</a></strong></h1>
</center>
...
echo "</table>
          <div style='border: 1px solid #ccc; padding: 10px; background-color: #f9f9f9; box-shadow: 2px 2px 8px rgba(0, 0, 0, 0.1); max-width: 100%; width: 100%; box-sizing: border-box; margin: 20px auto; font-size: 12px; text-align: center;'>
              &copy; " . date('Y') . " ✓ By <a href='' style='text-decoration: none; color: #007BFF; font-weight: bold;'>Halmahera1337</a>.
          </div>";?>
